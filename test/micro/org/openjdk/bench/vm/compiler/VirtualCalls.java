...
public class VirtualCalls {
    ...
    class SecondClassDontInline extends FirstClassDontInline {
        @CompilerControl(CompilerControl.Mode.DONT_INLINE)
        public int getIntFirst() {
            return 2;
        }
    ...
    class ThirdClassDontInline extends SecondClassDontInline {
        @CompilerControl(CompilerControl.Mode.DONT_INLINE)
        public int getIntFirst() {
            return -3;
        }
    ...
    class FourthClassDontInline extends ThirdClassDontInline {
        @CompilerControl(CompilerControl.Mode.DONT_INLINE)
        public int getIntFirst() {
            return -4;
        }
    ...
    class FifthClassDontInline extends FourthClassDontInline {
        @CompilerControl(CompilerControl.Mode.DONT_INLINE)
        public int getIntFirst() {
            return -5;
        }
    ...
    public FirstClass[] as = new FirstClass[asLength];
    public FirstClassDontInline[] noninlined = new FirstClassDontInline[asLength];
    ...
    @Benchmark
    public int testCall(Blackhole bh) {
        FirstClassDontInline ai = noninlined[l];
        l = ++ l % asLength;
        return ai.getIntFirst();
    }

    /**
     * Call address computation within loop but the receiver preexists
     * the loop and the ac can be moved outside of the loop
     */
    @Benchmark
    public int test1stClass2Types() {
        FirstClass ai = as[l];
        l = 1 - l;
        return ai.getIntFirst();
    }
